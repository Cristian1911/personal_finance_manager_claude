...
```bash
python3 .Codex/skills/codebase-context/scripts/build_context.py
```
...
```bash
bash .Codex/skills/codebase-context/scripts/install_git_hook.sh
```
...
| Tier | Codex | Codex / OpenAI |
|------|-------------|----------------|
| Fast/cheap — scans, incremental refreshes | `Codex-haiku-4-5` | `gpt-5-mini` |
| Deep — architecture synthesis, risky migrations | `Codex-sonnet-4-6` | `gpt-5` |
