...
- **(P2) Cuotas compartidas antes de importar el resto.** Si el usuario reparte la cuota 3 desde el viaje (`shareModoTransactions`) sin pasar por el import, se reparte como cuota suelta (monto de la cuota). Reusar la regla de compra completa también ahí cuando la fila tenga `installment_group_id`.
